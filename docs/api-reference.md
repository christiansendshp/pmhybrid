...
| `/health`                                 | health                | Terminus healthcheck (DB connectivity) — readiness; `GET /health/live` answers without the database, for liveness (Roadmap IMPROVEMENT-02c, `docs/deployment.md`)                                                                                                                                             |
