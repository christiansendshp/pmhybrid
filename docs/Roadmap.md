...
(GAP-12–GAP-19) and the 2026-09-16 frontend redesign (GAP-20) are all DONE
— see `Agentslog.md`/`Features.md`. GAP-21–GAP-26 below are a fresh
brief-vs-code review done 2026-09-16 against the original brief
(`Prompt — Desarrollo de Project Management Hub Humano + IA.md`), covering
what the brief asks for that the app does not yet do. None are started.

## Near term

| ID     | Outcome                                                                                                                                                                                                                                                                                                                      | Acceptance check                                                                                                                                                                                                                           | Status | Depends on |
| ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------ | ---------- |
| GAP-21 | Progress rollup strategy is configurable on the API (`progressRollupStrategy` in create/update project DTOs) but never exposed in the UI — every project silently gets the schema default, unchangeable (brief §16 "estrategia configurable")                                                                                | My Projects' create form offers a rollup-strategy select; Project Settings lets it be changed after creation; new web unit + api e2e coverage; `docs/domain-model.md` updated if the default changes                                       | TODO   | —          |
