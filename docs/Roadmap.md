...
| ------ | ------------------------------------------------------------ | -------------------------------------------------- | ----------- | -------------------------------- | ---------- |
| GAP-06 | Kanban cards with all §15 fields + search, grouping, sorting | web unit tests for grouping/sorting; browser check | IN_PROGRESS | claude-code@2026-09-15T14:30:00Z | GAP-03     |
