...
| ------ | -------------------------------------------------------------- | ------------------------------------- | ----------- | -------------------------------- | ---------- |
| GAP-10 | Conflict field diff + MANUAL_EDIT resolution in UI (brief §26) | web unit test for diff; browser check | IN_PROGRESS | claude-code@2026-09-15T16:20:00Z | GAP-03     |
