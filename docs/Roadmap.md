...
— see `Agentslog.md`/`Features.md` (F31 for GAP-27). GAP-21–GAP-26 below are
...
what the brief asks for that the app does not yet do. GAP-21 is in progress;
